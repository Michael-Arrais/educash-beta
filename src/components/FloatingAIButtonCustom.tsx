    ...
    <div className="fixed bottom-6 right-6 z-50">
      {isOpen ? (
        <div className="bg-white rounded-lg shadow-lg w-80 md:w-96 overflow-hidden">
          <div className="bg-primary p-3 flex justify-between items-center text-white">
            <div className="flex items-center">
              ...
              <h3 className="font-semibold">Assistente CashIA</h3>
            </div>
        ...
        >
          ...
          <span className="sr-only">Fale com o CashIA</span>
          <span className="absolute -top-1 -right-1 text-xs bg-white text-primary px-2 py-0.5 rounded-full font-medium">Fale com o CashIA</span>
        </Button>
      )}
    </div>
  );
